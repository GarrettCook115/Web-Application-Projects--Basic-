...
*Code Projects are executable by running code in an IDE**
 ...
 __FlaskApp1.html__ enables the FlaskApp.py file to execute in a web browser at the specified 127.0.0.1 loopback address. "The FlaskApp1.html must be in a folder called (templates) or else running the FlaskApp.py won't execute on the browser."
 ...
 __WndCmds.py__ is a basic (The First) implementation of this self-made project. Firstly, learning what different Python libraries like Tkinter did, and later creating small labels, 
 buttons, and subprocesses to make this simplistic application. Tkinter is a Python library useful for creating small, simple widgets for smaller applications, such as this. 

 __PocketCommand.py__ is a cleaner variant of WndCmds.py, offering more options and OS command selections beyond Windows. 
 It also implements several run command selections, including Performance monitoring, Windows version, and Event log viewer. "Based on what OS it's running on."
...
__Requirements:__
IDE 
To execute the Flask.py File and the others as well
1. Run it,  
2. Ctrl + click the address to open the web browser. (Specifically for the FlaskApp.py file) The others run within a tkinter window with widgets. 
...
__Completed Released App with frequent updates:__ https://github.com/GarrettCook115/WebSite-Command-Prompt-Execution-APPS/releases/tag/v1.0.0

Source files if you want to download: Or just check the code in the main repos.:
