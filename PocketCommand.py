...
commands ={
    "Windows":{
        #These commands will be added in future versions once scrolling messagebox has been implemented. (Text cut off and doesn't display all info)
